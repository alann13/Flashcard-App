...
export function StatisticCard({ title, value, icon: Icon, iconBgColor }: StatisticCardProps) {
  return (
    <div className="flex w-full items-start justify-between overflow-hidden rounded-xl border-[1px_2px_2px_1px] border-neutral-900 bg-neutral-0">
      <div className="flex h-full flex-1 flex-col items-start justify-between gap-2 p-5 leading-[1.2]">
        ...
        <p className="text-center text-[40px] font-bold leading-[1.2] text-neutral-900">{value}</p>
      </div>
      <div
        className={cn(
